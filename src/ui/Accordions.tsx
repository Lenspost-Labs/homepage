				...
				return (
					<>
						<Disclosure as="div" className="mb-5">
							{({ open }) => (
								<>
									<Disclosure.Button className="flex flex-row w-full justify-between rounded-2xl bg-theme-light-purple-50 px-4 py-4 text-left text-base lg:text-xl font-medium  hover:bg-theme-light-purple items-center focus:outline-none focus-visible:ring focus-visible:ring-theme-light-purple/75">
